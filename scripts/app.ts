...
(function()
{
    //Create a authguard function which ensures that the user is logged in before
    //accessing the pages in our protected routes.
    ...
    //Create a Loadlink function which takes in argumentts and displays the link for the argument passed to it.
    //depending on the conditions put in place.
    ...
    //Add events for the links in the navbar like the click event, mouseover event, etc.
    ...
    //This function is for displaying the products page.
    function DisplayProductsPage(): void
    {
        console.log("Products Page");
    }

    //This function is for displaying the services page.
    function DisplayServicesPage(): void
    {
        console.log("Services Page");
    }

    //This function is for displaying the about page.
    ...
    //This function makes use of our validate field function and validates the contact form.
    ...
    //this function is for displaying the contact page.
    ...
    //This function is for displaying the contact list page.
    ...
    //This function is used to check to see that a user is logged in and perform some commands based on that else it
    // also performs other commands.
    ...
    function CheckLogin(): void
    {
        ...
        if(sessionStorage.getItem("user"))
        {
            $("#task-list").html(`<li><a class="nav-link" data="task-list"><i class="fas fa-tasks">
            </i> Task List</a></li>`);
    ...
    //This function is used for displaying the login page.
    ...
    //This function is for displaying the register page.
     ...
     */
     ...
     {
         console.log("Display Task list page called");
